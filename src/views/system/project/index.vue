<template>
  ...
  <!-- 子表的列表 -->
  <ContentWrap>
    <el-tabs model-value="pic">
      <el-tab-pane label="图片" name="pic">
        <PicList :project-id="currentRow.id" />
      </el-tab-pane>
      <el-tab-pane label="属性" name="prop">
        <PropList :project-id="currentRow.id" />
      </el-tab-pane>
    </el-tabs>
  </ContentWrap>
</template>
...
import { ProjectApi, ProjectVO } from '@/api/system/project'
